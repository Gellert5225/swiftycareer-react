...
const customTheme: CustomFlowbiteTheme['dropdown'] = {
	...
	content: "py-1 pb-2 focus:outline-none",
	floating: {
		...
		style: {
			dark: "bg-mainBlueLight text-white dark:bg-mainBlueLight",
			light: "border border-gray-200 bg-white text-gray-900",
			auto: "border border-gray-200 bg-white text-gray-900 dark:border-none dark:bg-mainBlueLight dark:text-white"
		},
		target: "w-fit"
	},
...
const NavBar = () => {
	...
	const [openSearchModal, setOpenSearchModal] = useState<string | undefined>();
				...
				<div className="mx-auto max-w-6xl px-6 sm:px-6 lg:px-8">
					<div className="relative flex h-16 items-center justify-between">
						<div className="flex flex-1 sm:items-stretch justify-between">
							<div className="flex flex-shrink-0 items-center justify-between">
								...
								{user && user.on_board ?
									<div className='h-full flex items-center'>
										...
										<div className='ml-10 px-3 h-full flex items-center sm:hidden cursor-pointer' onClick={()=> setOpenSearchModal('search-modal')}>
							...
							{user ?
								user.on_board ?
									<div className="flex w-[75%] sm:w-[362px]">
											...
											index !== 4 ?
												<Link
													...
													className={classNames(
														...
														'flex items-center justify-center rounded-md p-1 text-sm font-medium w-full'
													)}
												...
												>
													<div className='px-2 pt-2'>
														...
														<button
															type="button"
															className='focus:outline-none focus:ring-0 text-blue-500 font-semibold rounded-full text-sm h-7 w-full text-center border hover:border-2 border-blue-500'
														>
															View Profile
														</button>
													</div>
													...
													<div className='ml-5'>
														<p
															className='cursor-pointer hover:underline text-sm text-gray-300'
